(() => {
  ...
  function bind() {
    ...
    main.addEventListener('click', e => {
      ...
      if (e.target.closest('[data-back-incidents]')) { window.location.href = 'incident-center.html'; return; }
      const toast = e.target.closest('[data-detail-toast]');
